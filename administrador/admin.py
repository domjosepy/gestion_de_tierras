...
from .models import Rol, User, Grupo, TipoObjetivo
...
@admin.register(TipoObjetivo)
class TipoObjetivoAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'grupo', 'activo', 'creado_por', 'fecha_creacion')
    list_filter = ('activo', 'grupo', 'fecha_creacion')
    search_fields = ('nombre', 'descripcion', 'grupo__nombre')
    readonly_fields = ('fecha_creacion', 'fecha_actualizacion', 'creado_por')
