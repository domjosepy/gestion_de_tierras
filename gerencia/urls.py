...
urlpatterns = [
    ...
    path('colonias/eliminar/<int:colonia_id>/',
     ...
     # ------------------------------------
     path('solicitudes-relevamiento/', lista_solicitudes_relevamiento, name='lista_solicitudes_relevamiento'),
     path('solicitudes-relevamiento/<int:pk>/datos/', obtener_datos_solicitud, name='obtener_datos_solicitud'),
