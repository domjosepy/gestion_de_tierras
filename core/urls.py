...
urlpatterns = [
    ...
    #path("departamentos/", views.DepartamentoListView, name="departamentos_list"),
    #path("departamentos/nuevo/", views.DepartamentoCreateView, name="departamentos_create"),
    #path("departamentos/<int:pk>/editar/", views.DepartamentoUpdateView, name="departamentos_edit"),
    #path("departamentos/<int:pk>/eliminar/", views.DepartamentoDeleteView, name="departamentos_delete"),
